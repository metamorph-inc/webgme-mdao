...
define([
    ...
    DataflowControl = function (options) {
    ...
    DataflowControl.prototype._initWidgetEventHandlers = function () {
    ...
    DataflowControl.prototype.selectedObjectChanged = function (nodeId) {
    ...
    DataflowControl.prototype._getObjectDescriptor = function (nodeId) {
    ...
    DataflowControl.prototype._onUnload = function (gmeId) {
        this._widget.removeNode(gmeId);
    };

    DataflowControl.prototype._stateActiveObjectChanged = function (model, activeObjectId) {
    ...
    DataflowControl.prototype.destroy = function () {
        this._detachClientEventListeners();
        this._removeToolbarItems();
    };

    DataflowControl.prototype._attachClientEventListeners = function () {
        this._detachClientEventListeners();
        WebGMEGlobal.State.on('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged, this);
    };

    DataflowControl.prototype._detachClientEventListeners = function () {
        WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
    };

    DataflowControl.prototype.onActivate = function () {
    ...
    DataflowControl.prototype.onDeactivate = function () {
        this._detachClientEventListeners();
        this._hideToolbarItems();
    };

    /* * * * * * * * * * Updating the toolbar * * * * * * * * * */
    DataflowControl.prototype._displayToolbarItems = function () {
    ...
    DataflowControl.prototype._hideToolbarItems = function () {
    ...
    DataflowControl.prototype._removeToolbarItems = function () {
    ...
    DataflowControl.prototype._initializeToolbar = function () {
        var self = this,
